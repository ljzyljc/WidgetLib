...
import com.finance.commonlib.util.DisplayUtil;

/**
 * Created by Jackie on 2018/4/19.
 * 可拖拽listview(点击item右侧十分之九到最右侧可移动item)
 */
...
//                    handler.removeCallbacks(mScrollRunnable);
    ...
    private void onDragItem(int moveX,int moveY){
        //移动的时候更新镜像
        mWindowParams.y = moveY+ DisplayUtil.dip2px(context,47);
...
//        mWindowParams.format = PixelFormat.TRANSPARENT;
        ...
        mWindowParams.x = 0;
        mWindowParams.y = mY+DisplayUtil.dip2px(context,63) ;
